...
abstract class ShaderDebugHelper extends RenderStateShard {
    ...
    protected static ShaderStateShard MY_DEBUG_SHADER;
    ...
    static void initDebugShader() {
        if (myDebugShader == null) {
            ...
            try {
                ...
                MY_DEBUG_SHADER = new ShaderStateShard(ShaderDebugHelper::getRenderTypeMyShader);
            } catch (IOException e) {
                e.printStackTrace();
...
class DebugShader extends net.minecraft.client.renderer.ShaderInstance {
    ...
    private static Program getOrCreate(
        ...
        try {
            ...
            program = Program.compileShader(type, name, file, "betternetherambientmobs", new GlslPreprocessor() {
