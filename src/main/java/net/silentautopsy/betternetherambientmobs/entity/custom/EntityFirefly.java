...
import net.silentautopsy.betternetherambientmobs.registry.EntitiesRegistry;
import net.silentautopsy.betternetherambientmobs.registry.SoundsRegistry;
import net.silentautopsy.betternetherambientmobs.registry.TagsRegistry;
...
public class EntityFirefly extends DespawnableAnimal implements FlyingAnimal
{
    ...
    protected void defineSynchedData()
    {
        ...
        makeColor(random.nextFloat(), random.nextFloat() * 0.5F + 0.25F);
    }
    ...
    @Override
    public float getWalkTargetValue(@NotNull BlockPos pos, LevelReader worldView)
    {
    ...
    {
        return EntitiesRegistry.FIREFLY.type().create(world);
    }
    ...
    static class FreflyLookControl extends LookControl
    {
    ...
    class WanderAroundGoal extends Goal
    {
        ...
        public void start()
        {
            ...
            if (path != null) EntityFirefly.this.navigation.moveTo(path, 1.0D);
            else EntityFirefly.this.setDeltaMovement(0, -0.2, 0);
            super.start();
        }
        ...
        private BlockPos getRandomLocation()
        {
            ...
            {
                int y = bpos.getY() - 1;
                while (w.isEmptyBlock(bpos.below(2)) && y > 0) bpos.setY(y--);
                return bpos;
            }
            ...
            if (airTarget == null) airTarget = HoverRandomPos.getPos(EntityFirefly.this, 16, 10, angle.x, angle.z, 1.5707964F, 3, 1);
    ...
    class MoveToFlowersGoal extends Goal
    {
        ...
        public void stop()
        {
            if (isFlower(EntityFirefly.this.getFeetBlockState())) EntityFirefly.this.mustSit = true;
            super.stop();
        }
        ...
        private BlockPos getFlowerLocation()
        {
            ...
            {
                bpos.set(EntityFirefly.this.getX() + offset.getX(), EntityFirefly.this.getY() + offset.getY(), EntityFirefly.this.getZ() + offset.getZ());
                if (isFlower(w.getBlockState(bpos))) return bpos;
            }
            return null;
        }
        ...
        {
            return state.is(TagsRegistry.FIREFLY_FLOWERS);
        }
    ...
    class SittingGoal extends Goal
    {
        ...
        {
            timer = 0;
            amount = EntityFirefly.this.random.nextInt(21) + 20;
    ...
    class MoveRandomGoal extends Goal
    {
        ...
        public void start()
        {
            ...
            if (velocity.lengthSqr() == 0) velocity = new Vec3(1, 0, 0);
    ...
    {
        return randRange(0.1F, 0.3F, random);
    }
    ...
    private void makeColor(float hue, float saturation)
    {
        float red = 0;
        float green = 0;
        float blue = 0;
        ...
        float f5 = (1.0F - saturation);
        float f6 = (1.0F - saturation * f4);
        float f7 = (1.0F - saturation * (1.0F - f4));
        switch ((int) f3) {
            case 0:
                red = (byte) (255F + 0.5F);
    ...
    static
    {
        ArrayList<Vec3i> points = new ArrayList<>();
        int radius = 6;
